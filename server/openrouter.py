...
SESSION_MEMORY_RESOLVER_SYSTEM_PROMPT = (
    ...
    "When newly revealed evidence gives a provisional location its proper name, put its existing durable ID in resolved_location_refs and set rename_existing true there; do not create a second location ID. "
