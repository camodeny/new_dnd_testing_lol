...
def build_session_hot_context(campaign, session, current_user, recent_messages_override=None):
    ...
    context = {
        ...
        'tool_policy': (
            ...
            '(for example a saboteur delivering a cover-story), add an info attribute to the npc tag explaining the in-world '
            'reason so the memory writer can downgrade certainty: '
            '<npc target="Orin" info="cover story; Orin is canonically Lady Cinder\'s saboteur">. '
