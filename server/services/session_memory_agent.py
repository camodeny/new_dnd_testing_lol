...
SESSION_MEMORY_EXTRACTION_TOOL = {
    ...
    'function': {
        ...
        'description': 'Submit the extracted candidate memory state for this visible turn. Call this exactly once.',
        'parameters': {
            'type': 'object',
            'required': ['running_summary'],
            'properties': {
                'running_summary': {'type': 'string'},
                'memory_anchors': {'type': 'object'},
                'scene_patch': {'type': 'object'},
                'scene_reason': {'type': 'string'},
                'fact_claims': {'type': 'array'},
                'entity_claims': {'type': 'array'},
                'relation_claims': {'type': 'array'},
                'npc_claims': {'type': 'array'},
                'event_claims': {'type': 'array'},
            },
        },
    },
}
...
SESSION_MEMORY_FINAL_PATCH_TOOL = {
    ...
    'function': {
        ...
        'description': 'Submit the fully resolved memory patch. Call this exactly once after any needed read-only lookups.',
        'parameters': {
            'type': 'object',
            'required': ['running_summary'],
            'properties': {
                ...
                'scene_patch': {'type': 'object'},
                'scene_reason': {'type': 'string'},
                'upsert_graph_entities': {'type': 'array'},
                'upsert_graph_relations': {'type': 'array'},
                'upsert_graph_facts': {'type': 'array'},
                'update_npc_actors': {'type': 'array'},
                'record_events': {'type': 'array'},
                'unresolved_items': {'type': 'array'},
                'evidence_basis': {'type': 'array'},
                'resolved_entity_refs': {'type': 'array'},
                'resolved_location_refs': {'type': 'array'},
            },
        },
    },
}
...
SESSION_CLOCK_UPDATES_TOOL = {
    ...
    'function': {
        ...
        'description': 'Submit the campaign clock adjudication for this visible turn. Call this exactly once.',
        'parameters': {
            'type': 'object',
            'properties': {
                'create_clocks': {'type': 'array'},
                'advance_clocks': {'type': 'array'},
                'retire_clocks': {'type': 'array'},
                'no_change_explanations': {'type': 'array'},
            },
        },
    },
}
