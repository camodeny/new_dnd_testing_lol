...
def _question_instructions(question_id: str, evidence: JudgeEvidence) -> str:
    ...
    if question_id == JUDGE_SECRECY_RISK:
        return (
            ...
            "wording IS a violation. Entries tagged [unknown to speaker X] "
            "are speaker-scoped: they are violations only when the candidate "
            "has that speaker state or reveal their substance; another "
            "speaker who knows the fact may state it.\n"
